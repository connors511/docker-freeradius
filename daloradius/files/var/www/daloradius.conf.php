...
$configValues['CONFIG_DB_HOST'] = getenv('DALORADIUS_DB_HOST');
$configValues['CONFIG_DB_PORT'] = getenv('DALORADIUS_DB_PORT');
$configValues['CONFIG_DB_USER'] = getenv('DALORADIUS_DB_USER');
$configValues['CONFIG_DB_PASS'] = getenv('DALORADIUS_DB_PASS');
$configValues['CONFIG_DB_NAME'] = getenv('DALORADIUS_DB_NAME');
